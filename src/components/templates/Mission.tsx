    ...
    <Base pageContext={pageContext}>
      <div className="py-10 md:py-0 auto-phrase">
        ...
        <p className="text-xl my-5">
          複雑化する社会、組織、ソフトウェア、サービスと生きる現代。それらの余計なものを削ぎ落とし、本質と向き合う社会を目指します。
        </p>
        <h2
          id="バリュー"
          className="text-6xl font-semibold md:text-4xl relative pb-7 pt-20 -mt-10 before:content-[''] before:block before:absolute before:left-0	before:bottom-0 before:w-full	before:h-px	before:bg-gray-200 after:content-[''] after:block after:absolute after:left-0	after:bottom-0 after:w-1/3	after:h-px	after:bg-gray-600"
        ...
        <ul className="text-xl pl-3 list-['-']">
          <li className="pl-2">AI拡張型エンジニアリングによる生産性の向上</li>
          <li className="pl-2">
            クラウドネイティブアーキテクチャによるスケーラビリティやレジリエンスの強化・コスト最適化
          </li>
          <li className="pl-2">
            プラットフォームエンジニアリングによるデリバリ・パイプラインの最適化
          </li>
        </ul>
        <p id="体制" className="text-xl my-5">
          代表社員、従業員、外部パートナーが一つとなり、ミッション推進のために積極的にコミュニケーションツールを導入して密な情報共有を行います。
        </p>
        <p id="環境整備" className="text-xl my-5">
          業務時間の20%を利用して、ミッションを実行するための自己の時間として費やします。
        </p>
        <h3
          id="修証一等"
          className="text-4xl font-semibold md:text-2xl pt-21 -mt-10"
        ...
        <blockquote className="text-xl mt-5 before:content-['“'] before:text-2xl	before:text-gray-400 before:font-bold before:mr-1 after:content-['”'] after:text-2xl after:text-gray-400 after:font-bold after:ml-1">
      ...
      公開日時：<time dateTime="2024-01-11">2024年01月11日</time>
    </Base>
  );
};
